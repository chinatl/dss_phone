...
class IndexList extends Component {
  ...
  render() {
    ...
    return (
      <Spin spinning={this.props.loading} size="large" tip="加载中..."style={{height:'300px'}}>
      <div className={styles.indexList} /**/style={{height:'300px'}}>
        <Card 
          bodyStyle={{padding:'10px',height:'300px'}}
		style={{height:'300px'}}
          title={
...
export default connect(({ dataCache, user, widgets },{type}) => ({
