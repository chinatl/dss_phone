...
class PremTrend extends Component {
    ...
    render() {
        ...
        return (
            <Spin spinning={this.props.loading} size="large" tip="加载中..." style={{height:'100px'}} className={styles.PremTrend}>
                <Card
                    title={this.props.type === 'Mobile' ? " " : "保费平台"}
                    extra={
                        <div style={{ marginRight: '15px' }} className={styles.TableSelect} style={{backgroundColor: '#F15246'}}>
						   <Radio.Group size="small" value={this.props.params ? this.props.params.time : ''} onChange={(v) => {
                            ...
                            }} className={styles.dwmy} style={{	backgroundColor: '#F15246'}}>
